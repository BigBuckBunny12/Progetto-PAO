/********************************************************************************
** Form generated from reading UI file 'updatemediadialog.ui'
**
...
#ifndef UI_UPDATEMEDIADIALOG_H
#define UI_UPDATEMEDIADIALOG_H
...
public:
    ...
    void setupUi(QWidget *CreateMediaDialog)
    {
        ...
        label = new QLabel(CreateMediaDialog);
